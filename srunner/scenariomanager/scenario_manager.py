...
from srunner.scenariomanager.scenarioatomics.atomic_behaviors import UpdateControlForAllAgents
...
class Scenario(object):
    ...
    def __init__(self, behavior, criteria, name, timeout=60, terminate_on_failure=False):
        ...
        if self.name == "OpenScenario":
            self.scenario_tree.add_child(UpdateControlForAllAgents())
